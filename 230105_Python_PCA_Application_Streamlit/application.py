...
if uploaded_file is not None:
    ...
    categorical_variable = settings_column.selectbox('Select First Variable', options=cat_cols)
    categorical_variable_2 = settings_column.selectbox('Select Second Variable', options=cat_cols)
    ...
    scatter_column.plotly_chart(px.scatter(data_frame=pca_data, x=pca_1, y=pca_2, color=categorical_variable, template='seaborn', height=500,hover_data=[categorical_variable_2]), use_container_width=True)
